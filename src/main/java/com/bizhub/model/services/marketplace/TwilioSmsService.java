...
public class TwilioSmsService {
    ...
    public TwilioSmsService() {
        ...
        this.accountSid = EnvConfig.getRequired("TWILIO_ACCOUNT_SID");
        this.authToken  = EnvConfig.getRequired("TWILIO_AUTH_TOKEN");
        this.fromNumber = EnvConfig.getRequired("TWILIO_FROM_NUMBER");
